---
title: "R Social Sciences Lesson"
authors: 
...
This lesson is based on the [Social Sciences Data Carpentry lesson](https://datacarpentry.github.io/r-socialsci/).
...
The data files for the lesson can be downloaded manually here: [https://github.com/datacarpentry/r-socialsci/blob/main/episodes/data/SAFI_clean.csv](https://github.com/datacarpentry/r-socialsci/blob/main/episodes/data/SAFI_clean.csv)
...
- A description of each variable is available [here](https://datacarpentry.org/socialsci-workshop/index.html#data)
...
## Date formats {.hcenter}

![](images/date_formats.png){fig-align="center"}
...
## Reshaping data {.hcenter}

![](images/separate_longer.png){fig-align="center" width="700"}

## Reshaping data {.hcenter}

![](images/pivot_wider.png){fig-align="center" width="700"}
